...
public class PasswordValidator {
    ...
    private static final String RULE_SPECIAL = ".*[^A-Za-z0-9].*";
    ...
    public static boolean isValid(String password) {
        ...
        Pattern patternSpecial = Pattern.compile(RULE_SPECIAL);
        Matcher matcherSpecial = patternSpecial.matcher(password);

        return matcherUppercase.matches() && matcherNumeric.matches() && matcherSpecial.matches();
    }
